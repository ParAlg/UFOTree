...
int main(int argc, char** argv) {
  ...
  std::tuple<std::string, std::function<std::vector<Update>(vertex_t, long)>, bool, int> test_cases[] = {
    {"Zipf Tree", dynamic_tree_benchmark::zipf_tree_benchmark<1.01>, true, 1},
    {"Zipf Tree", dynamic_tree_benchmark::zipf_tree_benchmark<1.10>, true, 1},
    {"Zipf Tree", dynamic_tree_benchmark::zipf_tree_benchmark<1.25>, true, 1},
    {"Zipf Tree", dynamic_tree_benchmark::zipf_tree_benchmark<1.5>, true, 1},
    {"Zipf Tree", dynamic_tree_benchmark::zipf_tree_benchmark<1.75>, true, 1},
    {"Zipf Tree", dynamic_tree_benchmark::zipf_tree_benchmark<2.0>, true, 1},
    {"Zipf Tree", dynamic_tree_benchmark::zipf_tree_benchmark<4.0>, true, 1},
  };
