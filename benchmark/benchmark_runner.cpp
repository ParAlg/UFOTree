...
int main(int argc, char** argv) {
    ...
    // vertex_t n_list[] = {1000000, 10000000, 100000000};
    ...
    for (vertex_t n : n_list) {
        ...
        // std::cout << "RCTree        ";
        // dynamic_tree_benchmark::linked_list_benchmark<RCTree<empty_t>>(n);
        std::cout << "TopologyTree  " << std::endl;
        dynamic_tree_benchmark::linked_list_benchmark<TopologyTree<empty_t>>(n);
        std::cout << "UFOTree       " << std::endl;
        dynamic_tree_benchmark::linked_list_benchmark<UFOTree<empty_t>>(n);
        ...
        // std::cout << "[ RUNNING " << test_case << " BENCHMARK WITH n=" << n << " ]" << std::endl;
        // // std::cout << "RCTree        ";
        // // dynamic_tree_benchmark::binary_tree_benchmark<RCTree<empty_t>>(n);
        // std::cout << "TopologyTree  ";
        // dynamic_tree_benchmark::binary_tree_benchmark<TopologyTree<empty_t>>(n);
        // std::cout << "UFOTree       ";
        // dynamic_tree_benchmark::binary_tree_benchmark<UFOTree<empty_t>>(n);
        // // std::cout << "EulerTourTree ";
        ...
        // std::cout << "[ RUNNING " << test_case << " BENCHMARK WITH n=" << n << " ]" << std::endl;
        // std::cout << "UFOTree       ";
        // dynamic_tree_benchmark::k_ary_tree_benchmark<UFOTree<empty_t>>(n);
        // // std::cout << "EulerTourTree ";
        ...
        // std::cout << "[ RUNNING " << test_case << " BENCHMARK WITH n=" << n << " ]" << std::endl;
        // std::cout << "UFOTree       ";
        // dynamic_tree_benchmark::star_benchmark<UFOTree<empty_t>>(n);
        // // std::cout << "EulerTourTree ";
        ...
        // std::cout << "[ RUNNING " << test_case << " BENCHMARK WITH n=" << n << " ]" << std::endl;
        // // std::cout << "RCTree        ";
        // // dynamic_tree_benchmark::random_degree3_benchmark<RCTree<empty_t>>(n);
        // std::cout << "TopologyTree  ";
        // dynamic_tree_benchmark::random_degree3_benchmark<TopologyTree<empty_t>>(n);
        // std::cout << "UFOTree       ";
        // dynamic_tree_benchmark::random_degree3_benchmark<UFOTree<empty_t>>(n);
        // // std::cout << "EulerTourTree ";
        ...
        // std::cout << "[ RUNNING " << test_case << " BENCHMARK WITH n=" << n << " ]" << std::endl;
        // std::cout << "UFOTree       ";
        // dynamic_tree_benchmark::random_unbounded_benchmark<UFOTree<empty_t>>(n);
        // // std::cout << "EulerTourTree ";
        ...
        // std::cout << "[ RUNNING " << test_case << " BENCHMARK WITH n=" << n << " ]" << std::endl;
        // std::cout << "UFOTree       ";
        // dynamic_tree_benchmark::preferential_attachment_benchmark<UFOTree<empty_t>>(n);
        // // std::cout << "EulerTourTree ";
