...
# Here, we check the first row for an extra column with NaN values in other rows
...
values = data.iloc[:, 1:]     # All other columns for the bars
...
# Wrap long category labels to multiple lines
